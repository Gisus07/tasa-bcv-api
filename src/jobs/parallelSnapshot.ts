...
import { getParallelSnapshot, type ParallelSnapshot } from '../services/binance/client.js';
 ...
 */
export async function runParallelSnapshot(d: Database): Promise<ParallelSnapshot | null> {
